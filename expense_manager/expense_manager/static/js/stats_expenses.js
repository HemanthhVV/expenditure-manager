    ...
    options: {
        ...
        plugins: {
            title: {
                ...
                text: 'Expenses spent by category',  // The title text
                font: {
...
const renderPolarChart = (labels,datum) => {
    ...
    options: {
        plugins: {
            title: {
                display: true,  // Show the title
                text: 'Category used most',  // The title text
                font: {
                    size: 18  // Font size for the title
                },
                padding: {
    ...
    new Chart(ctx2, {
        ...
        options: {
            plugins: {
                title: {
                    display: true,  // Show the title
                    text: 'Expenses spent with respect to time',  // The title text
                    font: {
                        size: 18  // Font size for the title
                    },
                    padding: {
